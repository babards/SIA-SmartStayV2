...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="badge bg-primary rounded-pill px-3 py-2 fs-6">{{ $propertyStats['total_properties'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span><i class="fas fa-check-circle text-secondary me-2"></i>Available:</span>
                            <span class="badge bg-success rounded-pill px-3 py-2 fs-6">{{ $propertyStats['available_properties'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span><i class="fas fa-users text-secondary me-2"></i>Fully Occupied:</span>
                            <span class="badge bg-info rounded-pill px-3 py-2 fs-6">{{ $propertyStats['occupied_properties'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title mb-3">
                            <i class="fas fa-file-alt text-primary me-2"></i>Application Statistics
                        </h5>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span><i class="fas fa-clipboard-list text-secondary me-2"></i>Total Applications:</span>
                            <span class="badge bg-primary rounded-pill px-3 py-2 fs-6">{{ $applicationStats['total_applications'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span><i class="fas fa-clock text-secondary me-2"></i>Pending:</span>
                            <span class="badge bg-warning text-dark rounded-pill px-3 py-2 fs-6">{{ $applicationStats['pending_applications'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span><i class="fas fa-check text-secondary me-2"></i>Approved:</span>
                            <span class="badge bg-success rounded-pill px-3 py-2 fs-6">{{ $applicationStats['approved_applications'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span><i class="fas fa-times text-secondary me-2"></i>Rejected:</span>
                            <span class="badge bg-danger rounded-pill px-3 py-2 fs-6">{{ $applicationStats['rejected_applications'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span><i class="fas fa-ban text-secondary me-2"></i>Cancelled:</span>
                            <span class="badge bg-secondary rounded-pill px-3 py-2 fs-6">{{ $applicationStats['cancelled_applications'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title mb-3">
                            <i class="fas fa-user-friends text-primary me-2"></i>Boarder Statistics
                        </h5>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span><i class="fas fa-users text-secondary me-2"></i>Total Boarders:</span>
                            <span class="badge bg-primary rounded-pill px-3 py-2 fs-6">{{ $boarderStats['total_boarders'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span><i class="fas fa-user-check text-secondary me-2"></i>Active:</span>
                            <span class="badge bg-success rounded-pill px-3 py-2 fs-6">{{ $boarderStats['active_boarders'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span><i class="fas fa-user-times text-secondary me-2"></i>Kicked:</span>
                            <span class="badge bg-danger rounded-pill px-3 py-2 fs-6">{{ $boarderStats['kicked_boarders'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Properties Map -->
        <h3 class="text-center mb-4">My Properties Map</h3>
